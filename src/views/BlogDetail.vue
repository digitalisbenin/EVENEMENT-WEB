<template>
  <img src="../assets/8.jpg" alt="" class="" loading="lazy" />
  <div class="bg-white">
    
    <div class="lg:flex lg:mx-12 mx-6 mt-4">
      <h1
        class="text-gray-900 lg:text-3xl text-lg font-bold  lg:ml-4"
      >
        Autres évènements
      </h1>
      ...
      <div class="lg:ml-auto">
        <div
          class="rounded-lg lg:ml-9 lg:ml-0 text-gray-900 p-1 border border-gray-300 bg-white overflow-hidden ring-red-300 focus:ring-4 mt-4 lg:mt-0 lg:w-96 flex items-center"
        >
          <input
            type="text"
            v-model="filter"
        ...
        <div class="relative bg-white p-6 rounded-lg w-11/12 max-w-lg">
         ...
         <button
          ...
          <img
            ...
            alt="Image de l'événement"
            class="transform transition duration-300 hover:scale-105  rounded-lg" style="height: 350px; width: 500px;"
    ...
    >
      ...
      <section class=" mt-6 rounded-lg shadow-md lg:mx-14 mx-6 bg-gray-200 lg:h-16 mb-4">
...
<div class="text-black">
  <h3 class="text-xl md:text-2xl font-semibold normal-case animate-color-pulse italic">
    Vous voulez voir plus d'événements en cours ou à venir ? Cliquez ici.
  </h3>
</div>
      ...
      <!-- Button -->
       <router-link
      to="/eventsencours" class="bg-white text-[#5DAE99] font-semibold px-6 italic py-3 rounded-lg shadow-md hover:bg-gray-100 transition animate-fadeInUp flex items-center space-x-2">
        <span>Voir plus</span>
  ...
  <div class="container mx-auto px-4 ">
    <div class=" rounded-xl p-2 flex flex-col md:flex-row items-center justify-between  md:space-y-0 md:space-x-6">
      ...
      <!-- Icon + Text -->
       ...
       <router-link
      to="/eventsterminer" class="bg-white text-[#5DAE99] font-semibold italic px-6 py-3 rounded-lg shadow-md hover:bg-gray-100 transition animate-fadeInUp flex items-center space-x-2">
        <span>Voir plus</span>
        <!-- <i class="fas fa-chevron-right"></i> -->
          </router-link>
...
,
    searchAction() {
      ...
      this.filteredDemandes = this.demandes.filter((restaurant) => {
        const name =
          restaurant.name && typeof restaurant.name === "string"
