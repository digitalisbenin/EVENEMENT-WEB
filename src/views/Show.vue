  ...
  <div class="container mx-auto px-4 ">
    <div class=" rounded-xl p-2 flex flex-col md:flex-row items-center justify-between  md:space-y-0 md:space-x-6">
      ...
      <!-- Icon + Text -->
       ...
       <router-link
      to="/eventcategorieterminer/1" class="bg-white text-[#5DAE99] font-semibold italic px-6 py-3 rounded-lg shadow-md hover:bg-gray-100 transition animate-fadeInUp flex items-center space-x-2">
        <span>Voir plus</span>
        <!-- <i class="fas fa-chevron-right"></i> -->
          </router-link>
