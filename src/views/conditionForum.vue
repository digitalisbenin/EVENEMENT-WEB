...
<img src="../assets/4.jpg" alt="" class="" loading="lazy" />
  <div class="bg-white">
      ...
      <div class="h-9"></div>
       ...
       <h1 class="text-gray-900 lg:text-3xl text-lg font-bold mt-4 lg:mt-0 lg:ml-4">
...
export default {
  ...
  methods: {
   ...
   async getdemande() {
      try {
        const response = await axios.get( `/api/demandestype?type_demande_id=${this.$route.params.id}`);
        if (response.data) {
